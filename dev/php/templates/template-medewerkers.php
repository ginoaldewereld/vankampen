			...
			<div class="container">
			  	<div class="keynote">
			    	...
			    	<div class="keynote-desc">
			     		...
			     		<p class="keynote-bio">Petra werkt van maandag tot en vrijdag van 9.00 uur tot 17.00 uur, maar legt regelmatig cliëntbezoeken af en is daardoor niet altijd op kantoor te vinden. <a href="" class="more">Mail Petra</a></p>
			   		</div>
			  	</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="keynote">
				    ...
				    <div class="keynote-desc">
				     	...
				     	<p class="keynote-bio">Coby is tevens onze bureaumanager. Coby werkt op dinsdag tot en met vrijdag van 8.30 uur tot 17.00 uur.<a href="" class="more">Mail Coby</a>
				    </div>
				</div>
			</div>
		</div>
		<div class="u-gridCol5">
			<div class="keynote">
				    ...
				    <div class="keynote-desc">
				     	...
				     	<p class="keynote-bio">Irena werkt maandag, dinsdag, donderdag en vrijdag van 8.30 uur tot 17.00 uur.<a href="" class="more">Mail Irena</a>
				    </div>
			</div>
		</div>
		<div class="u-gridCol11 jaarstukken">
			...
			<div class="container">
				<div class="keynote">
				    ...
				    <div class="keynote-desc">
				     	...
				     	<p class="keynote-bio">Jan werkt van maandag tot en met vrijdag van 8.30 uur tot 17.00 uur.<a href="" class="more">Mail Jan</a>
				    </div>
				</div>
			</div>
		</div>
		<div class="u-gridCol5">
			<div class="keynote">
				    ...
				    <div class="keynote-desc">
				     	...
				     	<p class="keynote-bio">Sjon is onregelmatig aanwezig op ons kantoor en heeft geen vaste werktijden.<a href="" class="more">Mail Sjon</a>
				    </div>
			</div>
		</div>
			...
			<div class="container">
				<div class="keynote">
				    ...
				    <div class="keynote-desc">
				     	...
				     	<p class="keynote-bio">Henk werkt van maandag tot en met woensdag van 8.30 uur tot 17.30 uur.<a href="" class="more">Mail Henk</a>
				    </div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="keynote">
				    ...
				    <div class="keynote-desc">
				     	...
				     	<p class="keynote-bio"><a href="" class="more">Mail Mariëlle</a>
				    </div>
				</div>
			</div>
		</div>
